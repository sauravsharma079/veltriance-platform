...
import {
  ...
  Plug, Code2, Package, History, Bot, FileSignature, Gavel, Receipt, Wallet, ShieldCheck,
} from "lucide-react";
...
const NAV_ITEMS: { href: string; label: string; icon: typeof LayoutDashboard; roles: Role[]; module?: LicenseModuleKey }[] = [
  ...
  { href: "/dashboard/budgets",        label: "Budgets",         icon: Wallet,            roles: ["PROCUREMENT","ADMIN"], module: "INTAKE_TO_PO" },
  { href: "/dashboard/policies",       label: "Policies",        icon: ShieldCheck,       roles: ["PROCUREMENT","ADMIN"], module: "INTAKE_TO_PO" },
