...
import { onboardingAgent } from "@/lib/agents/definitions/onboarding-agent";
...
export const AGENTS: AgentDef[] = [documentChaser, contractNegotiator, contractRenewalWatch, rfqAssistant, bidEvaluator, onboardingAgent];
