...
export default function PrintPage() {
  ...
  return <>
    ...
    <div className="page">
      <div className="hdr"><div><div className="brand">Veltriance</div><div className="brand-sub">Technologies LLP</div><div className="brand-addr">Procurement Platform<br/>{po.organization?.name||"—"}</div></div><div className="por"><div className="pot">PURCHASE ORDER</div><div className="pon">{po.poNumber}</div><div><span className="badge">{po.status}</span></div></div></div>
